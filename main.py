...
'''mail_settings = {
    ...
    "MAIL_USE_TLS": False,
    "MAIL_USE_SSL": True,
    "MAIL_USERNAME": os.environ['mayur.s.deshmukh10@gmail.com'],
    "MAIL_PASSWORD": os.environ['Mayur@1092']
}'''
...
app.config.update(
	...
	MAIL_PORT=465,
	MAIL_USE_SSL=True,
	MAIL_USERNAME = 'mayur.s.deshmukh1092@gmail.com',
	MAIL_PASSWORD = 'Mayur@1092'
	)
...
conn = MySQLdb.connect(host='localhost',user='mayur',passwd = 'mayur2219981092',port = 8090,db="car_rental")
cursor = conn.cursor()
